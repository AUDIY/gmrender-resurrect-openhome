...
static struct var_meta control_var_meta[] = {
	...
	[CONTROL_VAR_PRESET_NAME_LIST] = { "PresetNameList", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	...
	[CONTROL_VAR_BRIGHTNESS] =       { "Brightness", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &brightness_range },
	[CONTROL_VAR_CONTRAST] =         { "Contrast", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &contrast_range },
	[CONTROL_VAR_SHARPNESS] =        { "Sharpness", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &sharpness_range },
	[CONTROL_VAR_R_GAIN] =           { "RedVideoGain", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &vid_gain_range },
	[CONTROL_VAR_G_GAIN] =           { "GreenVideoGain", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &vid_gain_range },
	[CONTROL_VAR_B_GAIN] =           { "BlueVideoGain", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &vid_gain_range },
	[CONTROL_VAR_R_BLACK] =          { "RedVideoBlackLevel", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &vid_black_range },
	[CONTROL_VAR_G_BLACK] =          { "GreenVideoBlackLevel", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &vid_black_range },
	[CONTROL_VAR_B_BLACK] =          { "BlueVideoBlackLevel", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &vid_black_range },
	[CONTROL_VAR_COLOR_TEMP] =       { "ColorTemperature", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &colortemp_range },
	[CONTROL_VAR_HOR_KEYSTONE] =     { "HorizontalKeystone", SENDEVENT_LASTCHANGE, DATATYPE_I2, NULL, &keystone_range },
	[CONTROL_VAR_VER_KEYSTONE] =     { "VerticalKeystone", SENDEVENT_LASTCHANGE, DATATYPE_I2, NULL, &keystone_range },
	[CONTROL_VAR_MUTE] =             { "Mute", SENDEVENT_LASTCHANGE, DATATYPE_BOOLEAN, NULL, NULL },
	[CONTROL_VAR_VOLUME] =           { "Volume", SENDEVENT_LASTCHANGE, DATATYPE_UI2, NULL, &volume_range },
	[CONTROL_VAR_VOLUME_DB] =        { "VolumeDB", SENDEVENT_LASTCHANGE, DATATYPE_I2, NULL, &volume_db_range },
	[CONTROL_VAR_LOUDNESS] =         { "Loudness", SENDEVENT_LASTCHANGE, DATATYPE_BOOLEAN, NULL, NULL },
