...
static struct var_meta transport_var_meta[] = {
	[TRANSPORT_VAR_TRANSPORT_STATE] =       { "TransportState", SENDEVENT_LASTCHANGE, DATATYPE_STRING, transport_states, NULL },
	[TRANSPORT_VAR_TRANSPORT_STATUS] =      { "TransportStatus", SENDEVENT_LASTCHANGE, DATATYPE_STRING, transport_stati, NULL },
	[TRANSPORT_VAR_PLAY_MEDIUM] =           { "PlaybackStorageMedium", SENDEVENT_LASTCHANGE, DATATYPE_STRING, media, NULL },
	[TRANSPORT_VAR_REC_MEDIUM] =            { "RecordStorageMedium", SENDEVENT_LASTCHANGE, DATATYPE_STRING, media, NULL },
	[TRANSPORT_VAR_PLAY_MEDIA] =            { "PossiblePlaybackStorageMedia", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_REC_MEDIA] =             { "PossibleRecordStorageMedia", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_CUR_PLAY_MODE] =         { "CurrentPlayMode", SENDEVENT_LASTCHANGE, DATATYPE_STRING, playmodi, NULL, "NORMAL" },
	[TRANSPORT_VAR_TRANSPORT_PLAY_SPEED] =  { "TransportPlaySpeed", SENDEVENT_LASTCHANGE, DATATYPE_STRING, playspeeds, NULL },
	[TRANSPORT_VAR_REC_MEDIUM_WR_STATUS] =  { "RecordMediumWriteStatus", SENDEVENT_LASTCHANGE, DATATYPE_STRING, rec_write_stati, NULL },
	[TRANSPORT_VAR_CUR_REC_QUAL_MODE] =     { "CurrentRecordQualityMode", SENDEVENT_LASTCHANGE, DATATYPE_STRING, rec_quality_modi, NULL },
	[TRANSPORT_VAR_POS_REC_QUAL_MODE] =     { "PossibleRecordQualityModes", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_NR_TRACKS] =             { "NumberOfTracks", SENDEVENT_LASTCHANGE, DATATYPE_UI4, NULL, &track_nr_range }, /* no step */
	[TRANSPORT_VAR_CUR_TRACK] =             { "CurrentTrack", SENDEVENT_LASTCHANGE, DATATYPE_UI4, NULL, &track_range },
	[TRANSPORT_VAR_CUR_TRACK_DUR] =         { "CurrentTrackDuration", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_CUR_MEDIA_DUR] =         { "CurrentMediaDuration", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_CUR_TRACK_META] =        { "CurrentTrackMetaData", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_CUR_TRACK_URI] =         { "CurrentTrackURI", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_AV_URI] =                { "AVTransportURI", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_AV_URI_META] =           { "AVTransportURIMetaData", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_NEXT_AV_URI] =           { "NextAVTransportURI", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	[TRANSPORT_VAR_NEXT_AV_URI_META] =      { "NextAVTransportURIMetaData", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
	...
	[TRANSPORT_VAR_CUR_TRANSPORT_ACTIONS] = { "CurrentTransportActions", SENDEVENT_LASTCHANGE, DATATYPE_STRING, NULL, NULL },
